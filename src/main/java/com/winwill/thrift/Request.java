...
public class Request implements
		org.apache.thrift.TBase<Request, Request._Fields>,
	...
	private static final org.apache.thrift.protocol.TField AGE_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"age", org.apache.thrift.protocol.TType.I32, (short) 3);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		 ...
		 * @see RequestType
		 */
		TYPE((short) 1, "type"), NAME((short) 2, "name"), AGE((short) 3, "age");
	...
	static {
		...
		tmpMap.put(_Fields.AGE, new org.apache.thrift.meta_data.FieldMetaData(
				"age", org.apache.thrift.TFieldRequirementType.OPTIONAL,
				new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.I32)));
		metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				Request.class, metaDataMap);
	}

	public Request() {
	}

	public Request(RequestType type, java.lang.String name) {
		this();
		this.type = type;
		this.name = name;
	}
	...
	public Request setType(
			@org.apache.thrift.annotation.Nullable RequestType type) {
		this.type = type;
		return this;
	}
	...
	public void unsetAge() {
		__isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(
				__isset_bitfield, __AGE_ISSET_ID);
	}
	...
	public void setAgeIsSet(boolean value) {
		__isset_bitfield = org.apache.thrift.EncodingUtils.setBit(
				__isset_bitfield, __AGE_ISSET_ID, value);
	}
	...
	public int compareTo(Request other) {
		...
		lastComparison = java.lang.Boolean.valueOf(isSetType()).compareTo(
				other.isSetType());
		if (lastComparison != 0) {
		...
		lastComparison = java.lang.Boolean.valueOf(isSetName()).compareTo(
				other.isSetName());
		if (lastComparison != 0) {
			return lastComparison;
		}
		...
		lastComparison = java.lang.Boolean.valueOf(isSetAge()).compareTo(
				other.isSetAge());
		if (lastComparison != 0) {
			return lastComparison;
		}
			...
			while (true) {
				...
				case 1: // TYPE
					if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
						struct.type = com.winwill.thrift.RequestType
	...
	private static class RequestTupleSchemeFactory implements
			org.apache.thrift.scheme.SchemeFactory {
	...
	private static class RequestTupleScheme extends
			org.apache.thrift.scheme.TupleScheme<Request> {
		...
		public void read(org.apache.thrift.protocol.TProtocol prot,
			...
			struct.type = com.winwill.thrift.RequestType.findByValue(iprot
					.readI32());
			struct.setTypeIsSet(true);
			struct.name = iprot.readString();
			struct.setNameIsSet(true);
