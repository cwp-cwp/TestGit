...
public class HelloWordService {
	...
	public interface Iface {
		...
		public java.lang.String doAction(Request request)
	...
	public static class Client extends org.apache.thrift.TServiceClient
		...
		public void send_doAction(Request request)
				throws org.apache.thrift.TException {
		...
		public java.lang.String recv_doAction() throws RequestException,
			...
			throw new org.apache.thrift.TApplicationException(
					...
					"doAction failed: unknown result");
		}
	...
	public static class AsyncClient extends
		...
		public void doAction(
				...
				throws org.apache.thrift.TException {
			checkReady();
			doAction_call method_call = new doAction_call(request,
					resultHandler, this, ___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}

		public static class doAction_call extends
				org.apache.thrift.async.TAsyncMethodCall<java.lang.String> {
			private Request request;

			public doAction_call(
					Request request,
					org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler,
			...
			public java.lang.String getResult() throws RequestException,
					org.apache.thrift.TException {
	...
	public static class Processor<I extends Iface> extends
		...
		public static class doAction<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, doAction_args> {
			public doAction() {
				super("doAction");
			}
			...
			public doAction_result getResult(I iface, doAction_args args)
					throws org.apache.thrift.TException {
				doAction_result result = new doAction_result();
				try {
	...
	public static class AsyncProcessor<I extends AsyncIface> extends
		...
		public static class doAction<I extends AsyncIface>
				extends
				org.apache.thrift.AsyncProcessFunction<I, doAction_args, java.lang.String> {
			public doAction() {
				super("doAction");
			}
	...
	public static class doAction_args implements
			org.apache.thrift.TBase<doAction_args, doAction_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<doAction_args> {
		...
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			...
			public static _Fields findByThriftIdOrThrow(int fieldId) {
				...
				if (fields == null)
					throw new java.lang.IllegalArgumentException("Field "
		...
		static {
			...
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					doAction_args.class, metaDataMap);
		}

		public doAction_args() {
		}

		public doAction_args(Request request) {
			this();
			this.request = request;
		}
		...
		public doAction_args setRequest(
				@org.apache.thrift.annotation.Nullable Request request) {
			this.request = request;
			return this;
		}
		...
		public int compareTo(doAction_args other) {
			...
			lastComparison = java.lang.Boolean.valueOf(isSetRequest())
					.compareTo(other.isSetRequest());
			if (lastComparison != 0) {
		...
		private static class doAction_argsStandardSchemeFactory implements
		...
		private static class doAction_argsStandardScheme extends
				org.apache.thrift.scheme.StandardScheme<doAction_args> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					doAction_args struct) throws org.apache.thrift.TException {
		...
		private static class doAction_argsTupleSchemeFactory implements
				org.apache.thrift.scheme.SchemeFactory {
		...
		private static class doAction_argsTupleScheme extends
				org.apache.thrift.scheme.TupleScheme<doAction_args> {
		...
		private static <S extends org.apache.thrift.scheme.IScheme> S scheme(
			...
			return (org.apache.thrift.scheme.StandardScheme.class.equals(proto
					.getScheme()) ? STANDARD_SCHEME_FACTORY
					: TUPLE_SCHEME_FACTORY).getScheme();
		}
	}

	public static class doAction_result implements
			org.apache.thrift.TBase<doAction_result, doAction_result._Fields>,
			java.io.Serializable, Cloneable, Comparable<doAction_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"doAction_result");

		private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"success", org.apache.thrift.protocol.TType.STRING, (short) 0);
		private static final org.apache.thrift.protocol.TField QE_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"qe", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
		 ...
		 */
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			SUCCESS((short) 0, "success"), QE((short) 1, "qe");
		...
		static {
			...
			tmpMap.put(_Fields.QE,
					new org.apache.thrift.meta_data.FieldMetaData("qe",
							org.apache.thrift.TFieldRequirementType.DEFAULT,
							new org.apache.thrift.meta_data.StructMetaData(
									org.apache.thrift.protocol.TType.STRUCT,
			...
			metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					doAction_result.class, metaDataMap);
		}

		public doAction_result() {
		}

		public doAction_result(java.lang.String success, RequestException qe) {
			this();
		...
		public doAction_result setSuccess(
		...
		public doAction_result setQe(
				@org.apache.thrift.annotation.Nullable RequestException qe) {
			this.qe = qe;
			return this;
		}
		...
		/**
		 * Returns true if field qe is set (has been assigned a value) and false
		 * otherwise
		 */
		...
		public int compareTo(doAction_result other) {
			...
			lastComparison = java.lang.Boolean.valueOf(isSetQe()).compareTo(
					other.isSetQe());
			if (lastComparison != 0) {
				return lastComparison;
			}
		...
		private static class doAction_resultStandardSchemeFactory implements
				org.apache.thrift.scheme.SchemeFactory {
		...
		private static class doAction_resultStandardScheme extends
				org.apache.thrift.scheme.StandardScheme<doAction_result> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					doAction_result struct) throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					schemeField = iprot.readFieldBegin();
		...
		private static class doAction_resultTupleSchemeFactory implements
				org.apache.thrift.scheme.SchemeFactory {
		...
		private static class doAction_resultTupleScheme extends
				org.apache.thrift.scheme.TupleScheme<doAction_result> {
